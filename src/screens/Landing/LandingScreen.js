    ...
    <div className="genericScreen">
      ...
      <div className='detailGenericContainer'>
        <div className="landingShiftContainer">
          ...
          {shiftId && shiftStart && <h3>Inicio de turno {moment(shiftStart).format('DD-MM-YYYY h:mm')}</h3>}
          {shiftId && shiftEnd && <h3>Fin de turno {moment(shiftEnd).format('DD-MM-YYYY h:mm')}</h3>}
